...
<body>
	...
	$nama = ""; // menyimpan variabel nama
	$email = ""; // menyimpan variabel email
	$web = ""; // menyimpan variabel web
	$pesan = ""; // menyimpan variabel pesan
	$telp = ""; // menyimpan variabel telp

	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		
		if (empty($_POST["nama"]))
		{
			$error_nama = "Nama tidak boleh kosong"; // jika nama kosong akan tampil teks nama tidak boleh kosong
		}
		else
		{
	...
	<?php
	echo "<h2>Your Input:</h2>"; // menampilkan teks Your input, heading 2
	echo "Nama = ".$nama; // menampilkan teks nama
	echo "<br>";
	echo "Email = ".$email; // menampilkan teks email
	echo "<br>";
	echo "Website = ".$web; // menampilkan teks website
	echo "<br>";
	echo "Telp = ".$telp; // menampilkan teks telp
	echo "<br>";
	echo "Pesan =  ".$pesan; // menampilkan teks pesan
	?>
</body>
</html>